...
class NewsListPageSearch extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => NewsListPageSearchState();
}

class NewsListPageSearchState extends State<NewsListPageSearch> {
