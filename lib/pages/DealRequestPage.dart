...
class DealRequestPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => DealRequestPageState();
}

class DealRequestPageState extends State<DealRequestPage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (listData == null) {
      ...
      return new DefaultTabController(
        ...
        child: new Scaffold(
          appBar: new AppBar(
            title: Text('Deal Requests'),
            bottom: new TabBar(
              tabs: [
                new Tab(text: "My Deal Requests"),
                new Tab(text: "Group Coupons"),
              ],
            ),
          ),
          body: new TabBarView(children: [listView, listView]),
        ),
      );
    }
  }
